...
//
// Keep this current with the shipping settings schema: a valid key
// missing here is a false positive that trains users to ignore the
// audit, which is worse than missing a rare typo. When in doubt, include
// the key.
var knownSettingsKeys = map[string]bool{
	...
	"language":                    true,
	"messageIdleNotifThresholdMs": true,
	"model":                       true,
